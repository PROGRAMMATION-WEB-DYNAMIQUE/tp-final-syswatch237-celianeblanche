...
fn machines() -> HashMap<String, String> {
    ...
    m.insert("PC-01-SOPPI".to_string(), "172.0.0.1".to_string());
    m.insert("PC-02-TAMBOU".to_string(), "172.0.0.1".to_string());
    m.insert("PC-03-METAMMO".to_string(), "172.0.0.1".to_string());
